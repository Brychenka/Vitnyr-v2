...
| J5 | The one conversion link doesn't name the offer and looks like the three below it | **Build** — landed 2026-09-12 (hierarchy `49426cd`, copy `a21c1b2`, Igor's own wording) | J3 |
...
| J3 — one loudest thing | J5 | **landed** 2026-09-12 — hierarchy `49426cd`, copy `a21c1b2` (outside this work order's own stage branches — Igor supplied the wording directly, see BUILD-NOTES 2026-09-12 "Section 05 rewritten...") |
